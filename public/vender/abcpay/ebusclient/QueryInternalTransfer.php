...
class QueryInternalTransfer extends TrxRequest {
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_QUERY_INTERNAL_TRANSFER,
        "TransferNo" => ""
    );
    ...
    protected function checkRequest() {
        if (empty($this->request["TransferNo"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "内转请求流水号未设定！");
    }
}
?>