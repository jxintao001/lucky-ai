...
class MerchantConfig {
	...
	//网上支付平台交易网址
	private static $iTrustPayFileTrxURL = '';
...
public static function getLogWriterObject($LogWriter) {
	...
	public static function getTrustPayFileTrxURL() {
		self :: bundle();
		return self :: $iTrustPayFileTrxURL;
	}
	...
	private static function bundle() {
		if (!self :: $iIsInitialed) {
			...
			self :: $iTrustPayFileTrxURL = self :: getParameterByName('TrustPayFileTrxURL');
