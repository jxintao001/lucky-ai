...
class SubMerMobileMessage extends TrxRequest{

    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_VERIFY_RESENDSMS,
        "SubMerId" => "",
        "SubMerchantAccNo" => ""
    );
    ...
    protected function checkRequest() {
        ...
        if (empty($this->request["SubMerchantAccNo"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1100, TrxException :: TRX_EXC_MSG_1100, "未设定出金账号！");
    }
