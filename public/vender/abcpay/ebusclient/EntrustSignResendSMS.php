...
class EntrustSignResendSMS extends TrxRequest {
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_ENTRUSTSIGN_RESENDSMS,
        "SignNo" => "",
        "CustomAccNo" => ""
    );
    ...
    protected function checkRequest() {
		...
		if (empty($this->request["CustomAccNo"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "客户签约卡号未设定！");
    }
}
?>