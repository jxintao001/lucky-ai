...
class RegisterSubMerchantInfo extends TrxRequest {

    //新版二级商户进件
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_SUBMER_REGSUBMERINFONEW,
        "SubMerId" => "",
        "IsNewFlag" => "",
        "SubMerName" => "",
        ...
        "ControllerCertType" => "",
        "ControllerCertNo" => "",
        "ControllerCertBegDate" => "",
        "ControllerCertEndDate" => "",
        "ControllerResidence" => "",
        "FrIsAgent" => "",
        "AgentName" => "",
        "AgentCertType" => "",
        ...
        "Announce" => "",
        "Remark" => "",
        "NotifyUrl" => "http://10.72.213.117:8080"
    );
    ...
    protected function checkRequest() {
        ...
        if (empty($this->request["SubMerSort"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "二级客户种类未设定！");
