...
class FundTransferApplyQuery extends TrxRequest {
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_FUND_TRANSFERAPPLY_QUERY,
        "SerialNumber" => ""
    );
    ...
    protected function checkRequest() {
        if (empty($this->request["SerialNumber"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "OrderNo未设定！");
    }
}
?>