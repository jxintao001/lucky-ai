...
class SubsidyTransfer extends TrxRequest {
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_SUBSIDY_TRANSFER,
        "OrderNo" => "",
        "InternalTransferNo" => "",
    ...
    protected function checkRequest() {
        ...
        if (empty($this->request["Amount"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "补贴金额未设定！");
    }
}
?>