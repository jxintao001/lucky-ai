...
class CheckGuarantedFundAccDetail extends TrxRequest {
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_CHECK_GUARANTED_FUNDACCDETAIL,
        "AccDate" => "",
        "NumEntryRec" => "",
        "NumSeqDtal" => "",
        "JrnNo" => ""
    ...
    protected function checkRequest() {
        if (empty($this->request["AccDate"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "会计日期未设定！");
    }
}
?>