...
class ThdOrderConfirm extends TrxRequest {
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_CONFIRM_THIRDORDER,
        "OrderNo" => "",
        "NewOrderNo" => "",
        "OrderAmount" => ""
    );
    ...
    protected function checkRequest() {
        ...
        if(empty(count($this->splitaccinfos)))    //判断二级商户信息
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "确认二级商户不能为空！");
