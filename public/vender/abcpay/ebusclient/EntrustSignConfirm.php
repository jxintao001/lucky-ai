...
class EntrustSignConfirm extends TrxRequest {
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_ENTRUSTSIGN_CONFIRM,
        "SignNo" => "",
        "VerificationCode" => ""
    );
    ...
    protected function checkRequest() {
		...
		if (empty($this->request["VerificationCode"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "短信验证码未设定！");
    }
}
?>