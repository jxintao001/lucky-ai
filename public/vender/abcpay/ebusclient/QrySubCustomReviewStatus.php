...
class QrySubCustomReviewStatus extends TrxRequest {
    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_QRY_SUBCUSTOM_REVIEWSTATUS,
        "SubCustomNo" => "",
        "SerialNo" => ""
    );
    ...
    protected function checkRequest() {
        if (empty($this->request["SubCustomNo"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "二级客户编号未设定！");
