...
class MerFileReg extends TrxRequest{

    public $request = array (
        "TrxType" => IFunctionID :: TRX_TYPE_FILEREGISTER,
        "BatchDate" => "",
        "BatchNo" => "",
        "FileContent" => "111"
    );
    ...
    protected function checkRequest() {
        ...
        if (empty($this->request["BatchDate"]))
            throw new TrxException(TrxException :: TRX_EXC_CODE_1100, TrxException :: TRX_EXC_MSG_1100, "未设定登记日期！");
